...
<h3>Inserir Requerido</h3>
<?php echo form_open('requerido/add','class="form-horizontal validar" role="form"');?>
  <!-- tipo de pessoa-->
  <fieldset>
    ...
    <div class="pes-fisica" style="display:none;">
      <div class="form-group">
        ...
        <div class="col-lg-3">
          <input type="text" name="nm_requerido" class="form-control" placeholder="Nome do Requerido" validation="validate[required]">
        </div>
      </div>
      <div class="form-group">
        <label class="col-lg-2 control-label"><span>Cpf:</span></label>
        <div class="col-lg-2">
          <input type="text" name="nr_cpf" class="cpf form-control input-compare" id="cpf" placeholder="CPF do Requerido">
        </div>
      </div>
      <div class="form-group">
        <label class="col-lg-2 control-label"><span>RG:</span></label>
        <div class="col-lg-2">
          <input type="text" name="nr_rg" class="numeros form-control" placeholder="RG do Requerido">
        </div>
      </div>
    </div>
    ...
    <div class="pes-juridica" style="display:none;">
      <div class="form-group">
        ...
        <div class="col-lg-3">
          <input type="text" name="nm_requerido" class="form-control" placeholder="Razão Social" validation="validate[required]">
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-lg-2">
          <input type="text" name="nr_cpf" class="cnpj input-compare form-control" id="cnpj" placeholder="Cnpj do Requerido" validation="validate[required]">
        </div>
      </div>
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-2">
        <input type="text" name="ds_endcoml" class="form-control" placeholder="Endereço Comercial">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-2">
        <input type="text" name="nm_trabalho" class="form-control" placeholder="Local Trabalho">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-2">
        <input type="text" name="nr_fonecoml" class="form-control" placeholder="Telefone Comercial">
      </div>
    </div>
