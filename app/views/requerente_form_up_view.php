...
<h3>Vizualizar ou Alterar dados Requerente</h3>
<?php echo form_open('requerente/up/'.$row->cd_requerente,'class="form-horizontal validar" role="form"');?>
  <!-- tipo de pessoa-->
  <fieldset>
    ...
    <div class="pes-fisica">
      <div class="form-group">
        ...
        <div class="col-lg-3">
          <input type="text" name="nm_requerente" class="form-control" value="<?php echo $row->nm_requerente;?>" validation="validate[required]">
        </div>
      </div>
      <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-2">
      <input type="text" name="ds_atividade" class="form-control" value="<?php echo $row->ds_atividade;?>">
    </div>
  </div>
    ...
    <div class="form-group">
      <label class="col-lg-2 control-label"><span>Formas de Pagamento:</span></label>
        <label class="checkbox-inline">
          <input id="ChSCPC" name="fl_scpc" type="checkbox" value="S" <?php if($row->fl_scpc == 'S')echo 'checked';?>>SCPC
        </label>
        <label class="checkbox-inline">
          <input id="ChSCPC" name="fl_cerasa" type="checkbox" value="S" <?php if($row->fl_cerasa == 'S')echo 'checked';?>>Cerasa
        </label>
        <label class="checkbox-inline">
          <input id="ChSCPC" name="fl_negativa" type="checkbox" value="S" <?php if($row->fl_negativa == 'S')echo 'checked';?>>Negativa
        </label>
        <label class="checkbox-inline">
          <input id="ChSCPC" name="fl_vista" type="checkbox" value="S" <?php if($row->fl_vista == 'S')echo 'checked';?>>Vista
        </label>
        <label class="checkbox-inline">
          <input id="ChSCPC" name="fl_prazo" type="checkbox" value="S" <?php if($row->fl_prazo == 'S')echo 'checked';?>>Prazo
        </label>
        <label class="checkbox-inline">
          <input id="ChSCPC" name="fl_duplicata" type="checkbox" value="S" <?php if($row->fl_duplicata == 'S')echo 'checked';?>>Duplicata
        </label>
        <label class="checkbox-inline">
          <input id="ChSCPC" name="fl_cheque" type="checkbox" value="S" <?php if($row->fl_cheque == 'S')echo 'checked';?>>Cheque
        </label>
        <label class="checkbox-inline">
          <input id="ChSCPC" name="fl_cartao" type="checkbox" value="S" <?php if($row->fl_cartao == 'S')echo 'checked';?>>Cartão
        </label>
    </div>
  </fieldset>
