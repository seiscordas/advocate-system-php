...
<?php if($this->uri->segment(2) == prepara_impressao):?>
  ...
  <a href="<?php echo base_url($this->uri->segment(1).'/down_pdf/'.str_replace('/','-',$row->cd_processo));?>" class="btn btn-default">
    <span class="glyphicon glyphicon-eye-open"></span> Vizualizar
  </a>
  <a href="<?php echo base_url($this->uri->segment(1).'/down_pdf/'.str_replace('/','-',$row->cd_processo)).'/true';?>" class="btn btn-default">
